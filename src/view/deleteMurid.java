...
public class deleteMurid extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(deleteId, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 220, 190, -1));
        ...
        jPanel1.add(svBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(485, 330, 100, 30));
        ...
        jPanel1.add(ex, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 330, 100, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/staff (23).png"))); // NOI18N
    ...
    private void svBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_svBtnActionPerformed
        constructormurid mm = new constructormurid();
        String idMurid = deleteId.getText();
        mm.find(idMurid);
        if (mm.deleteMurid()) {
...
//            java.util.logging.Logger.getLogger(deleteMurid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new deleteMurid().setVisible(true);
//            }
//        });
//    }
