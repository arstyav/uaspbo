...
public class createKelas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        study = new javax.swing.JFormattedTextField();
        ...
        name.setBorder(null);
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 148, 210, 20));

        num.setBorder(null);
        jPanel1.add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 190, 210, -1));

        capacity.setBorder(null);
        jPanel1.add(capacity, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, 210, -1));

        study.setBorder(null);
        jPanel1.add(study, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 262, 210, 20));
        ...
        jPanel1.add(svBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 343, 100, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/staff (34).png"))); // NOI18N
    ...
    private void svBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_svBtnActionPerformed
        ...
        String jmlhStr = capacity.getText();
        int jmlhInt = Integer.parseInt(jmlhStr);
        ck.namaKelas = name.getText();
        ck.jumlahMurid = kpInt;
        ck.kapasitas = jmlhInt;
        ck.metodePengajaran = study.getText();
...
//    }
    ...
    private javax.swing.JFormattedTextField study;
